...
import com.developeralamin.easydownloader.databinding.ActivityWhatappBinding;
...
public class WhatappActivity extends AppCompatActivity {
    ...
    private ActivityWhatappBinding binding;
    private WhatappActivity activity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_whatapp);
